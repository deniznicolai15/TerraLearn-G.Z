  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-2xl mx-auto px-4 pt-32 pb-16">
        <h1 className="text-4xl font-bold text-foreground mb-8">Topic 1: Forest Ecosystems</h1>
        
        <Card className="p-8 mb-8">
          <h2 className="text-2xl font-semibold text-foreground mb-6">Share Your Reflection</h2>
          <p className="text-muted-foreground mb-6">
            Your reflection will be posted anonymously. Share your thoughts, observations, or questions about forest ecosystems.
          </p>
