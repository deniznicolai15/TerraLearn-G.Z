...
var topics = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        text: "<strong>1. Climate Regulation</strong> – Forests absorb carbon dioxide and release oxygen, acting as natural air conditioners. Through carbon storage and transpiration, they help cool the planet and mitigate global warming.\n\n<strong>2. Water Cycle Balance</strong> – By capturing rainfall and recharging aquifers, forests regulate river flow. Watersheds such as La Mesa (Metro Manila), Angat (Bulacan), and Pantabangan (Nueva Ecija) supply clean drinking water and irrigation for agriculture.\n\n<strong>3. Soil Protection</strong> – Tree roots stabilize slopes and prevent erosion. In mountainous areas like Benguet and the Cordilleras, forests reduce landslide risks and protect farming terraces.\n\n<strong>4. Coastal Defense</strong> – Mangrove forests in Palawan, Leyte, and other coastal provinces act as natural seawalls. They buffer communities against storm surges and typhoons, while also serving as nurseries for fish and crabs.\n\n<strong>5. Biodiversity Conservation</strong> – Philippine forests host thousands of species, many endemic. Iconic examples include the Philippine eagle, tarsier, and rafflesia (the world's largest flower). These ecosystems safeguard genetic diversity crucial for medicine, food, and ecological resilience.\n\n<strong>6. Disaster Risk Reduction</strong> – Forests lessen the impact of floods, droughts, and landslides by regulating water flow and maintaining soil integrity. Their role is especially critical during typhoon season.\n\n<strong>7. Agricultural Support</strong> – Watersheds sustain farming by providing irrigation. Forest litter enriches soil fertility, while shaded microclimates protect crops.\n\n<strong>8. Cultural and Economic Value</strong> – Forests provide timber, food, and medicinal plants. For indigenous groups like the Dumagat, Manobo, and Ifugao, forests are sacred spaces tied to identity, spirituality, and traditional knowledge.\n\n<strong>9. Livelihood and Tourism</strong> – Communities rely on forest products for income, while ecotourism sites such as Mt. Makiling and Mt. Apo showcase biodiversity and cultural heritage.\n\n<strong>10. Global Significance</strong> – As part of the Coral Triangle and biodiversity hotspots, Philippine forests contribute to international climate stability and conservation efforts."
      }
    ],
