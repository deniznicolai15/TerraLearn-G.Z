  ...
  },
  {
    ...
    sections: [
      { 
        ...
        text: "<ul><li>Limestone cliffs and karst formations shaped by water and rock interaction.</li><li>Pamitinan Cave with stalactites, stalagmites, and chambers that host bats and other cave‑dwelling species.</li><li>Part of the Sierra Madre, contributing to water regulation and serving as a natural shield against typhoons.</li></ul>",
      ...
      { 
        ...
        text: "<img src=\"https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-fKWRd2XMrR8Kq5uWlJqIQtpPBELNJB.png\" alt=\"Figure 2. Landmark halfway up Mt. Pamitinan\" style=\"margin-bottom: 20px; max-width: 100%; height: auto; border-radius: 8px;\" /><p><strong>Figure 2. Landmark halfway up Mt. Pamitinan</strong></p><ul><li>On <strong>April 12, 1895</strong>, <strong>Andres Bonifacio</strong>, <strong>Emilio Jacinto</strong>, and several <strong>Katipuneros</strong> gathered inside Pamitinan Cave in Rodriguez, Rizal.</li><li>The cave served as a secret meeting place and refuge, where new members were initiated into the Katipunan.</li><li>During this gathering, Bonifacio inscribed the words <em>\"Viva la Independencia Filipina\"</em> on the cave wall, marking the first recorded declaration of Philippine independence, more than a year before the Cry of Balintawak.</li><li>This act was symbolic rather than public—it was a solemn proclamation of freedom carried out in secrecy, but it planted the revolutionary spirit firmly in the hearts of the Katipuneros.</li></ul><p>The landmark shown in Figure 2, located midway up Mt. Pamitinan, connects to this revolutionary legacy. While the actual inscription was not visible during the hike, the climb itself reflects the historical weight of the mountain. Mt. Pamitinan is therefore remembered not only as a natural landscape but also as a heritage site, where limestone cliffs and caves became witnesses to the Filipino struggle for independence.</p>",
      ...
      { 
        title: "Myth & Folklore",
        text: "<p>Everything in nature carries a story—and Mt. Pamitinan is no exception. Beyond its limestone cliffs and revolutionary past, the mountain is wrapped in sabi‑sabi that locals have passed down for generations.</p><ul><li><strong>Bernardo Carpio's Struggle</strong> – The most famous legend tells of Bernardo Carpio, a mythical giant trapped between Mt. Pamitinan and Mt. Binacayan. Bound by enchantment, he is said to hold the two mountains apart to prevent them from colliding. Each time he strains against his chains, the ground trembles—explaining the earthquakes felt in the area.</li><li><strong>Symbol of Resistance</strong> – For many, Carpio's imprisonment is more than myth. It symbolizes the Filipino struggle against oppression, with the giant's eternal effort mirroring the people's fight for freedom and resilience.</li><li><strong>Whispers and Signs</strong> – Hikers and villagers alike recount strange experiences: faint voices or music echoing inside the cave, sudden gusts of wind, or footsteps when no one is near. Some even claim that unseen forces guide lost travelers back to the trail, as if guardians watch over the mountain.</li><li><strong>Mystical Presence</strong> – These stories blur the line between geology and myth. The same cliffs that hold evidence of ancient Earth processes are imagined as portals to another realm, where spirits and giants dwell unseen.</li></ul>"
      },
      { 
        title: "Did You Know?",
