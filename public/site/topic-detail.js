// ===== SCROLL TO TOP FROM QUIZ/GAME =====
document.addEventListener('DOMContentLoaded', function () {
  if (sessionStorage.getItem('scrollToTop') === 'true') {
    // Scroll to top immediately and after a short delay to ensure page is fully rendered
    window.scrollTo(0, 0);
    setTimeout(function () {
...
var topicsData = [
  {
    ...
    gallery: [
      { image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/IMG_7096.PNG-NZEEv4uTE7MVjw4McMJoRBXYnrUjxw.jpeg" },
      { image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/IMG_7101.PNG-ZhnebpUUb5pss3Ium2lTpyEKYgHSbe.jpeg" },
      { image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/IMG_7098.PNG-iX5SW9Wp7hME2zgkHPJSa3mRAORpdN.jpeg" },
      { image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/IMG_7100.PNG-GQJMwpN57lmfgcBD50sbu7NxGFpN9F.jpeg" },
      { image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/IMG_7102.PNG-AILNQSlYzsWNg9Li3np8PWAxsK92Xl.jpeg" },
      { image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/IMG_7097.PNG-jMJv1VXSgjbOPLF1lW2gA3xX7gJBpC.jpeg" },
      { image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/IMG_7103.PNG-uaXPDrvMzIySsTDqOUwT9ht43crPSg.jpeg" },
      { image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/IMG_7094.PNG-X93ugJIUG34RzlbAGGYW0sE3Q5OYni.jpeg" },
      { image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/IMG_7095.PNG-vyScQ8R71wnc0XvYLWoTL501ojjuiK.jpeg" },
      { image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/IMG_7099.PNG-KjkhrETWXwU2by0JNCWlB5Y6A0r4nr.jpeg" }
    ],
    sections: [
      {
  ...
  },
  {
    ...
    description: "Encounter the key animal species that inhabit the landscape and discover their importance to the ecosystem. It's a look at the delicate balance between human presence and wildlife survival.<br><br>Mount Pamitinan in Montalban, Rizal is a sanctuary for birds that serve as its key animal species. These avifauna, like the Philippine bulbul and tailorbird, are vital to the forest's health, acting as pollinators, seed dispersers, and insect controllers. By focusing on the mountain's birdlife, we see how biodiversity sustains the balance of this protected landscape.",
    gallery: [
      { image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/IMG_6164-PvzwNcJeyVnF3GAV3RxJInRj9WcQtf.jpg" },
      { image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/IMG_6152-hByfbL91Etuen2qHCHdGVjUbL3Qnna.jpg" },
      { image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/IMG_6150-xqg0Spc7jcxRqKZDMtQo9f9YqV1lrx.jpg" },
...
var quizzes = {
  ...
  3: [
    {
      question: "What does 'GROW' represent in the 3G concept?",
      options: ["Growing the economy", "The continuous regeneration and growth of forest ecosystems", "Growing more cities", "Agricultural expansion"],
      correct: 1, // B - The continuous regeneration and growth of forest ecosystems
    },
    {
      question: "What does 'GLOW' symbolize in forest ecosystems?",
      options: ["Electric lights in the forest", "The energy flowing through ecosystems connecting all living things", "Solar panels on trees", "Fire in the forest"],
      correct: 1, // B - The energy flowing through ecosystems connecting all living things
    },
    {
      question: "What does 'GREEN' represent beyond just a color?",
      options: ["A type of paint", "Photosynthesis and sustainable practices", "A forest brand name", "The color of money"],
      correct: 1, // B - Photosynthesis and sustainable practices
    },
    {
      ...
      correct: 1, // B - Photosynthesis
    },
    {
      question: "Which pigment in leaves captures sunlight for photosynthesis?",
      options: ["Melanin", "Carotene", "Chlorophyll", "Hemoglobin"],
      correct: 2, // C - Chlorophyll
    },
    {
      question: "What byproduct is released when plants perform photosynthesis?",
      options: ["Carbon dioxide", "Nitrogen", "Oxygen", "Methane"],
      correct: 2, // C - Oxygen
    },
    {
      question: "How do forests demonstrate the 'GLOW' concept at night?",
      options: ["Street lamps", "Bioluminescent fungi and organisms", "Moon reflection", "Electric wires"],
      correct: 1, // B - Bioluminescent fungi and organisms
    },
    {
      question: "What role do pollinators play in forest 'GLOW'?",
      options: ["They create light", "They are attracted to vibrant flower colors", "They eat the glow", "They hibernate"],
      correct: 1, // B - They are attracted to vibrant flower colors
    },
    {
      question: "What does 'going green' mean in terms of environmental practices?",
      options: ["Painting everything green", "Embracing sustainable practices that protect ecosystems", "Moving to green countries", "Eating only green vegetables"],
      correct: 1, // B - Embracing sustainable practices that protect ecosystems
    },
    {
      question: "Why is understanding plant growth (GROW) important for forest conservation?",
      options: ["It helps us build more buildings", "It helps us appreciate the cycles of life that sustain forests", "It makes cutting trees easier", "It's not important at all"],
      correct: 1, // B - It helps us appreciate the cycles of life that sustain forests
    },
  ],
  4: [
    {
...
function initializePage() {
  ...
  document.getElementById("detail-description").innerHTML = topicData.description.replace(/\n/g, "<br>");
  ...
  if (topicData.id === 4) {
    ...
    // Show the Gizmo quiz box for Topic 4
    var gizmoQuizBox = document.getElementById("gizmo-quiz-box");
    if (gizmoQuizBox) {
      gizmoQuizBox.style.display = "block";
    }
  }
  if (topicData.id === 3) {
    document.body.classList.add("topic-3");
    // Hide the intro section for Topic 3 (the description is shown elsewhere)
    var introSection = document.getElementById("intro-section");
    if (introSection) {
      introSection.style.display = "none";
    }
  ...
  if (introElement) {
    if (topicData.intro) {
      ...
      introElement.innerHTML = topicData.description.replace(/\n/g, "<br>");
    }
  }
      ...
      otherSections.forEach(function (item, idx) {
        ...
        if (idx === 0) {
          ...
          reflectionBox.innerHTML =
            ...
            '<p class="reflection-box-question">If forests hold mysteries like Biringan, what responsibilities do we have to protect them?</p>' +
            '</div>' +
  ...
  if (topicData.id === 2) {
    ...
    reflectionBox.innerHTML =
      ...
      '<div class="reflection-box-header">' +
      '<h3 class="reflection-box-title">Quicky lang!</h3>' +
      '<p class="reflection-box-question">Why do you think communities create sabi sabi (like Bernardo Carpio causing earthquakes)? How do these stories help people understand natural events?</p>' +
      '</div>' +
      '<div class="reflection-box-input-section">' +
  ...
  if (topicData.id === 3) {
    ...
    var alpinePlants = [
      { name: "Papaya", scientific: "Carica papaya", family: "Caricaceae", stations: "Station 1, Station 3", description: "A fast-growing, short-lived tree with a hollow, soft trunk and large palmate leaves divided into 5–9 lobes. Papaya produces clusters of small flowers and bears large, fleshy fruits.", ecosystemImpact: "Papaya fruits are consumed by birds, bats, and mammals, making it an important food source for wildlife. Its flowers support pollinators, while the plant itself helps cover soil and reduce erosion in cultivated areas. For humans, papaya is a staple fruit crop rich in vitamins and enzymes, and its leaves are sometimes used in traditional remedies.", image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/papaya-bwGc6sTL7wwrnU7ROeSGEgABFWBB3Z.png" },
      { name: "Balete", scientific: "Ficus benjamina", family: "Moraceae", stations: "Station 2, Station 4", description: "A large fig tree characterized by its glossy green leaves and extensive aerial roots that descend from branches to the ground, creating a complex network of trunks and supports.", ecosystemImpact: "Ecologically, Balete plays a crucial role by producing figs that serve as food for birds, bats, and other wildlife. Its aerial roots stabilize soil and prevent erosion, while the tree itself offers microhabitats for insects and small animals. Culturally, Balete is deeply embedded in Philippine folklore, often associated with myths and legends. In conservation areas like Mt. Pamitinan, it contributes to biodiversity and forest structure.", image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/balete-uD8LG0nv5dpZ8x3hN4Q5Dp8tqXxGlp.png" },
      { name: "Bukawé", scientific: "Cyrtochloa toppingii", family: "Poaceae", stations: "Station 1, Station 5", description: "A native bamboo species found in Philippine forests. It grows in clumps with tall, slender culms and narrow leaves. The culms are hollow, segmented, and flexible, making them suitable for weaving and landscaping.", ecosystemImpact: "Ecologically, Bukawé stabilizes soil and prevents erosion, especially in sloping areas. It provides habitat for insects and small animals and contributes to forest structure. Culturally and economically, it is used for making mats, fish corrals, and other traditional implements. Its presence in the PPL reflects both ecological importance and local livelihood connections.", image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/bukawe-r5327J0K9d35FQbW7VauZ5nFtTBJy1.png" },
      { name: "Gabi", scientific: "Colocasia esculenta", family: "Araceae", stations: "Station 3, Station 6", description: "A tropical plant with large, heart-shaped leaves borne on long petioles. The leaves are broad, with a prominent central vein and radiating lateral veins. It thrives in moist soils and shaded areas.", ecosystemImpact: "Gabi is widely cultivated for its edible corms, which are a staple food in many Filipino households. Ecologically, it helps cover soil and reduce erosion in wet areas. Its large leaves provide microhabitats for insects and contribute to the lush understory vegetation in tropical forests.", image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/gabi2-c5S7JbYNSFZUrjCUDbEVrkx6xZY9LT.jpg" },
      { name: "(No widely recognized local name recorded)", scientific: "Sterculia rubiginosa", family: "Malvaceae", stations: "Station 2, Station 7", description: "A small tree that grows in specialized forest habitats throughout Southeast Asia including the Philippines. The leaves are obovate and leathery, while the flowers are yellowish-green with purple spots. Status: NE - Not Evaluated.", ecosystemImpact: "This species contributes to the biodiversity of the forest understory, supporting pollinators and seed dispersers. Its restricted range makes it vulnerable to disturbance, so conserving Sterculia rubiginosa is important for maintaining ecological balance in the protected landscape.", image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/no%20widely%20recognized%20local%20name%20recordedd-Z90TsNRwRvKDeNtn88E0m2B9EIK59Y.png" },
      { name: "Bigonia (Begonia)", scientific: "Begonia spp.", family: "Begoniaceae", stations: "Station 4, Station 8", description: "A small flowering plant commonly found growing on limestone rocks and crevices. It features rounded, fleshy leaves and delicate pink or white flowers. Thrives in humid, shaded environments.", ecosystemImpact: "Begonias contribute to the biodiversity of the forest floor, providing microhabitats for insects and small organisms. Their ability to grow in rocky cracks helps stabilize soil and prevent erosion in fragile areas. While not a major food source, they add to the ecological diversity of the forest understory.", image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/bigonia-ndiihaZJKaMJnLMsWpFASj27KNqXvd.png" },
      { name: "Bracket Fungus / Lingzhi (Reishi)", scientific: "Ganoderma spp.", family: "Polyporaceae", stations: "Station 1, Station 6", description: "A large, woody, shelf-like mushroom with a broad brown cap and pale margin. It grows horizontally from tree bases and stumps in forested areas. The underside contains pores instead of gills.", ecosystemImpact: "Ecologically, bracket fungi are decomposers, breaking down wood and recycling nutrients back into the soil. They help maintain forest health by decomposing dead trees and organic matter. Some species of Ganoderma are used in traditional medicine, valued for their bioactive compounds.", image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/bracket%20fungus-qRcAatKeaibEwQkP0ODhoBfiG0qVVR.png" },
      { name: "Saging (Banana)", scientific: "Musa spp.", family: "Musaceae", stations: "Station 3, Station 5", description: "A fast growing herbaceous plant with large, elongated green leaves that grow in spirals from a central pseudostem. The plant produces hanging clusters of fruits after flowering.", ecosystemImpact: "Bananas provide food for humans, bats, birds, and insects. Their broad leaves create shade and microhabitats, while the plant helps stabilize soil in forest edges and trails. Economically, bananas are one of the most important crops in the Philippines, deeply tied to local diets and livelihoods.", image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/saging-uAqXoLLUqMy5zs9iefOEIQwDMblYAN.png" },
      { name: "Coral Ardisia", scientific: "Ardisia crenata", family: "Primulaceae", stations: "Station 2, Station 9", description: "A small evergreen shrub with glossy, dark green leaves and upright stalks bearing compact clusters of bright red berries. It thrives in shaded forest understories and rocky, humid environments.", ecosystemImpact: "Coral Ardisia provides food for birds and small mammals, aiding seed dispersal. Its dense foliage offers cover for understory wildlife and helps protect soil from erosion. While ecologically valuable, it can sometimes spread aggressively, so monitoring its growth is important in conservation areas.", image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/coral%20ardisia-R4qg5oXTUh4rzqtRhBTGFg0ONq4L75.png" },
      { name: "Pheasant's Tail Fern / Pakpak-lawin", scientific: "Microsorum punctatum", family: "Polypodiaceae", stations: "Station 1, Station 4", description: "A distinctive fern species with long, arching fronds that resemble a pheasant's tail. Abundant in misty mountain regions, it thrives in humid conditions and grows on forest floors and tree trunks.", ecosystemImpact: "Pheasant's Tail Fern provides microhabitats for insects and small animals. Its rosette structure collects organic debris and water, enriching nutrient cycles in the forest. Culturally, it is recognized as a decorative and medicinal plant in some communities.", image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/pheasant%27s%20Tail%20Fern-jTjN96Vj6LfHqc6f5WxxSAwB85dzuK.png" },
      { name: "Sambong", scientific: "Blumea balsamifera", family: "Asteraceae", stations: "Station 5, Station 8", description: "A perennial shrub with aromatic, hairy leaves and small white to yellowish flower clusters. It grows in open fields, forest edges, and disturbed areas throughout the Philippines.", ecosystemImpact: "Sambong is widely used in Philippine traditional medicine (notably for kidney health and as a diuretic). Ecologically, it stabilizes soil in open areas and contributes to secondary succession.", image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/sambong-34npAVVnzAIPqsWtM6yq7RZioKBVFI.png" },
      { name: "Siam Weed", scientific: "Chromolaena odorata", family: "Asteraceae", stations: "Station 6, Station 9", description: "A fast growing invasive shrub with triangular leaves and clusters of small white to pale purple flowers. It thrives in disturbed soils and spreads rapidly along trails and forest edges.", ecosystemImpact: "While sometimes used in folk medicine, Siam Weed is considered invasive. It competes aggressively with native plants, alters soil chemistry, and reduces biodiversity.", image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/siam%20weed-NVc8WJkkZ4iAaHA5vB99ZRxHT0tdKT.png" },
      { name: "Pink Trumpet Tree / Rosy Trumpet Tree", scientific: "Tabebuia rosea", family: "Bignoniaceae", stations: "Station 3, Station 7", description: "A deciduous tree known for its showy pink to white trumpet-shaped flowers. It blooms spectacularly during the dry season and is often planted for ornamental purposes along roadsides and in parks.", ecosystemImpact: "Tabebuia rosea provides nectar for pollinators and shade for understory plants. It is valued ornamentally and contributes to urban and rural biodiversity.", image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/pink%20trumpet%20tree-PH0OmhE1ECxD1S7Rb1I6aGDfWzVkmT.png" },
    ...
    if (featuredPlantsSection.parentNode) {
      featuredPlantsSection.parentNode.insertBefore(transectMapSection, featuredPlantsSection.nextSibling);
    } else {
      sectionsContainer.appendChild(transectMapSection);
    }
    ...
    // Insert after Transect Map section
    if (transectMapSection.parentNode) {
      transectMapSection.parentNode.insertBefore(catalogSection, transectMapSection.nextSibling);
    } else {
    ...
    // Add Matching Game Section for Topic 3
    var matchingGameBox3 = document.createElement("div");
    matchingGameBox3.className = "forest-game-box";
    matchingGameBox3.id = "start-matching-trigger-topic3";
    matchingGameBox3.innerHTML =
      '<a href="games/topic3-matching-game.html" class="game-box-link">' +
      '<div class="game-box-content">' +
      '<div class="game-box-icon">' +
      '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">' +
      ...
      '</div>' +
      '<div class="game-box-text">' +
      '<h3>Match the Plants!</h3>' +
      '<p>Test your knowledge by matching Alpine plant common names with their scientific names. A fun and interactive way to learn plant identification!</p>' +
      '</div>' +
      '<div class="game-box-arrow">' +
      '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">' +
      '<line x1="5" y1="12" x2="19" y2="12"></line>' +
    ...
    if (quizGameBox3.parentNode) {
      quizGameBox3.parentNode.insertBefore(matchingGameBox3, quizGameBox3.nextSibling);
    } else {
      sectionsContainer.appendChild(matchingGameBox3);
    }
  }
  ...
  if (topicData.id === 5) {
    ...
    reflectionBox5.className = "reflection-box-container";
    reflectionBox5.innerHTML =
      '<div class="reflection-box-inner">' +
      '<div class="reflection-box-header">' +
      '<h3 class="reflection-box-title">Quicky lang!</h3>' +
      '<p class="reflection-box-question">How do your everyday actions — whether in your community, school, or personal life — contribute to shaping and reshaping the environment, and what changes can you make to ensure that future generations inherit a healthier, more sustainable world?</p>' +
      '</div>' +
      '<div class="reflection-box-input-section">' +
      '<textarea class="reflection-box-textarea" id="topic5-reflection-input" placeholder="Share your reflection or thoughts about environmental sustainability..." maxlength="250"></textarea>' +
      '<div class="reflection-box-footer">' +
      '<span class="reflection-box-char-count"><span class="char-count-number">0</span>/250</span>' +
      '<div class="reflection-box-buttons">' +
      '<button class="reflection-box-submit-btn" id="topic5-reflection-submit">Submit Thought</button>' +
      '<button class="reflection-box-view-btn" id="topic5-reflection-view"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg> View Community Thoughts</button>' +
      '</div>' +
      '</div>' +
      '</div>' +
      '</div>' +
      '<div class="reflection-box-wall" id="reflection-wall-topic5" style="display: none;">' +
      '<div class="reflection-wall-header"><h4>Community Thoughts</h4><span class="thought-count">0 thoughts shared</span></div>' +
      '<div class="reflection-wall-grid" id="reflection-wall-grid-topic5">' +
      '<p class="reflection-wall-empty">No thoughts yet... be the first to share!</p>' +
      '</div>' +
      '</div>';
    ...
    var topic5ViewBtn = document.getElementById("topic5-reflection-view");
    var topic5CharCount = document.querySelector('.char-count-number');
    var topic5ReflectionWall = document.getElementById("reflection-wall-topic5");
    var topic5WallGrid = document.getElementById("reflection-wall-grid-topic5");
    ...
    function displayTopic5Reflections() {
      if (!topic5WallGrid) return;

      if (topic5Thoughts.length === 0) {
        topic5WallGrid.innerHTML = '<p class="reflection-wall-empty">No thoughts yet... be the first to share!</p>';
      } else {
        var thoughtsHTML = '';
        ...
        topic5WallGrid.innerHTML = thoughtsHTML;
      }
      // Update thought count
      var thoughtCount = topic5ReflectionWall.querySelector('.thought-count');
      if (thoughtCount) {
        thoughtCount.textContent = topic5Thoughts.length + ' thought' + (topic5Thoughts.length !== 1 ? 's' : '') + ' shared';
      }
    }
    ...
    // Toggle community thoughts view
    if (topic5ViewBtn) {
      topic5ViewBtn.addEventListener("click", function () {
        if (topic5ReflectionWall) {
          topic5ReflectionWall.style.display = topic5ReflectionWall.style.display === 'none' ? 'block' : 'none';
        }
      });
    }
...
function renderAvifaunaSection() {
  ...
  var avifaunaPreIntro = document.getElementById("avifauna-pre-intro");
  var avifaunaIntro = document.getElementById("avifauna-intro");

  avifaunaContainer.style.display = "block";
  avifaunaPreIntro.innerHTML = "Mount Pamitinan in Montalban, Rizal is a sanctuary for birds that serve as its key animal species. These avifauna, like the Philippine bulbul and tailorbird, are vital to the forest's health, acting as pollinators, seed dispersers, and insect controllers. By focusing on the mountain's birdlife, we see how biodiversity sustains the balance of this protected landscape.<br><br>";
  ...
  avifaunaSpecies.forEach(function (species) {
    ...
    if (species.voiceUrl) {
      ...
      controlsHTML =
        ...
        '<div class="voice-wave-playhead"></div>' +
        '<input type="range" class="voice-wave-slider" min="0" max="100" value="0" step="0.1" aria-label="Seek audio timeline" />' +
        '</div>' +
    ...
    if (species.voiceUrl) {
      ...
      var voiceWaveBarsContainer = voiceIndicator.querySelector(".voice-wave-bars");
      var voiceWaveProgress = voiceIndicator.querySelector(".voice-wave-progress");
      var voiceWavePlayhead = voiceIndicator.querySelector(".voice-wave-playhead");
      var voiceWaveSlider = voiceIndicator.querySelector(".voice-wave-slider");
      var audio = new Audio(species.voiceUrl);
      audio.crossOrigin = "anonymous";
      var voiceWaveBars = [];
      var waveformAnimationFrame = null;
      var analyserNode = null;
      var frequencyData = null;

      function seedWaveBars() {
        var totalBars = 40;
        voiceWaveBars = [];
        voiceWaveBarsContainer.innerHTML = "";

        for (var i = 0; i < totalBars; i++) {
          var bar = document.createElement("div");
          bar.className = "voice-wave-bar";
          voiceWaveBarsContainer.appendChild(bar);
      ...
      function resetWaveBars() {
        for (var i = 0; i < voiceWaveBars.length; i++) {
          var baseHeight = 18 + Math.abs(Math.sin((i / voiceWaveBars.length) * Math.PI)) * 28;
          voiceWaveBars[i].style.height = baseHeight + "%";
          voiceWaveBars[i].style.opacity = "0.55";
        }
      }

      function ensureWaveAnalyser() {
        if (analyserNode && frequencyData) return true;

        var AudioContextCtor = window.AudioContext || window.webkitAudioContext;
        if (!AudioContextCtor) return false;

        if (!sharedCardAudioContext) {
          sharedCardAudioContext = new AudioContextCtor();
        }

        try {
          var sourceNode = sharedCardAudioSourceNodes.get(audio);
          if (!sourceNode) {
            sourceNode = sharedCardAudioContext.createMediaElementSource(audio);
            sharedCardAudioSourceNodes.set(audio, sourceNode);
          }

          analyserNode = sharedCardAudioContext.createAnalyser();
          analyserNode.fftSize = 256;
          analyserNode.smoothingTimeConstant = 0.8;
          sourceNode.connect(analyserNode);
          analyserNode.connect(sharedCardAudioContext.destination);
          frequencyData = new Uint8Array(analyserNode.frequencyBinCount);
          return true;
        } catch (err) {
          console.warn("Could not initialize waveform analyser:", err);
          return false;
        }
      }
      ...
      function renderWaveform() {
        ...
        var binStride = Math.max(1, Math.floor(frequencyData.length / voiceWaveBars.length));
        for (var i = 0; i < voiceWaveBars.length; i++) {
          var start = i * binStride;
          var end = Math.min(frequencyData.length, start + binStride);
          var sum = 0;
          ...
          var avg = (sum / Math.max(1, end - start)) / 255;
          var barHeight = 12 + avg * 88;
          voiceWaveBars[i].style.height = barHeight + "%";
          voiceWaveBars[i].style.opacity = (0.35 + avg * 0.65).toFixed(2);
        }

        waveformAnimationFrame = requestAnimationFrame(renderWaveform);
      }

      function startWaveformAnimation() {
        if (!ensureWaveAnalyser()) {
          resetWaveBars();
          return;
        }

        if (sharedCardAudioContext && sharedCardAudioContext.state === "suspended") {
          sharedCardAudioContext.resume().catch(function () { });
        }
      ...
      function formatCardAudioTime(seconds) {
      ...
      function setCardButtonIcon(isPlaying) {
        if (isPlaying) {
          voiceBtn.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><rect x="6" y="4" width="4" height="16"/><rect x="14" y="4" width="4" height="16"/></svg>';
        } else {
          voiceBtn.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M8 5v14l11-7z"/></svg>';
        }
      }

      function updateTimelinePosition(percent) {
        var safePercent = Math.max(0, Math.min(100, percent || 0));
        voiceWaveProgress.style.width = safePercent + "%";
        voiceWavePlayhead.style.left = safePercent + "%";
        voiceWaveSlider.value = safePercent;
      }

      function resetTimeline(durationSeconds) {
        updateTimelinePosition(0);
        voiceDuration.textContent = "0:00 / " + formatCardAudioTime(durationSeconds);
      }

      function resetIndicatorUI(indicatorElement, durationSeconds) {
        if (!indicatorElement) return;
        var prevDuration = indicatorElement.querySelector(".voice-duration");
        var prevProgress = indicatorElement.querySelector(".voice-wave-progress");
        var prevPlayhead = indicatorElement.querySelector(".voice-wave-playhead");
        var prevSlider = indicatorElement.querySelector(".voice-wave-slider");
        var prevButton = indicatorElement.querySelector(".voice-indicator-btn");
        var prevBars = indicatorElement.querySelectorAll(".voice-wave-bar");

        indicatorElement.classList.remove("playing");
        if (prevButton) {
          prevButton.classList.remove("playing");
          prevButton.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M8 5v14l11-7z"/></svg>';
        }
        if (prevProgress) prevProgress.style.width = "0%";
        if (prevPlayhead) prevPlayhead.style.left = "0%";
        if (prevSlider) prevSlider.value = 0;
        if (prevDuration) prevDuration.textContent = "0:00 / " + formatCardAudioTime(durationSeconds);
        for (var i = 0; i < prevBars.length; i++) {
          var baseHeight = 18 + Math.abs(Math.sin((i / prevBars.length) * Math.PI)) * 28;
          prevBars[i].style.height = baseHeight + "%";
          prevBars[i].style.opacity = "0.55";
        }
      }

      audio.addEventListener("loadedmetadata", function () {
        resetTimeline(audio.duration);
      });
      ...
      audio.addEventListener("timeupdate", function () {
        if (audio.duration) {
          ...
          voiceDuration.textContent = formatCardAudioTime(audio.currentTime) + " / " + formatCardAudioTime(audio.duration);
        }
      });

      audio.addEventListener("play", function () {
        voiceIndicator.classList.add("playing");
        voiceBtn.classList.add("playing");
        setCardButtonIcon(true);
        startWaveformAnimation();
      });

      audio.addEventListener("pause", function () {
        voiceIndicator.classList.remove("playing");
        voiceBtn.classList.remove("playing");
        setCardButtonIcon(false);
      ...
      audio.addEventListener("ended", function () {
        ...
        if (currentCardAudio === audio) {
          ...
          currentCardPlayButton = null;
        }
      });

      voiceWaveSlider.addEventListener("click", function (e) {
        e.stopPropagation();
      });

      voiceWaveSlider.addEventListener("mousedown", function (e) {
        e.stopPropagation();
      });

      voiceWaveSlider.addEventListener("touchstart", function (e) {
        e.stopPropagation();
      });

      voiceWaveSlider.addEventListener("input", function (e) {
        e.stopPropagation();
        if (!audio.duration) return;

        var percent = Number(voiceWaveSlider.value);
        audio.currentTime = (percent / 100) * audio.duration;
        updateTimelinePosition(percent);
        voiceDuration.textContent = formatCardAudioTime(audio.currentTime) + " / " + formatCardAudioTime(audio.duration);
      });

      voiceWaveSlider.addEventListener("change", function (e) {
        e.stopPropagation();
      });
      ...
      voiceBtn.addEventListener("click", function (e) {
        ...
        if (currentCardAudio && currentCardAudio !== audio) {
          currentCardAudio.pause();
          currentCardAudio.currentTime = 0;
          resetIndicatorUI(currentCardIndicator, currentCardAudio.duration);
        }

        if (audio.paused) {
          audio.play();
          currentCardAudio = audio;
          currentCardIndicator = voiceIndicator;
          currentCardPlayButton = voiceBtn;
        } else {
          audio.pause();
          if (currentCardAudio === audio) {
            currentCardAudio = null;
...
var currentCardPlayButton = null;
var sharedCardAudioContext = null;
var sharedCardAudioSourceNodes = new WeakMap();
